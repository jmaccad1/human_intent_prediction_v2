...
def __build_dataloader(
    ...
    **kwargs,
    ...
    assert name in [
        ...
        "video_attention_target_video",
        "hiphop_dataset_vat",
    ], f'{name} not in ("gazefollow", "video_attention_target", "video_attention_target_video", "hiphop_dataset_vat")'
    ...
    if name in ["video_attention_target_video", "hiphop_dataset_vat"]:
